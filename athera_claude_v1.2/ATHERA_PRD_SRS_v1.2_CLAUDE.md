> ## ⛔ منسوخة | Superseded
>
> **منذ 2026-08-31 لم تعد هذه الوثيقة مصدر الحقيقة.** المرجع النافذ هو مواصفة ATHERA v2.0،
> والقرار موثّق في [`docs/adr/ADR-0005-v2-repositioning.md`](../docs/adr/ADR-0005-v2-repositioning.md).
> التفصيل في [`SUPERSEDED.md`](SUPERSEDED.md).
>
> **§3 و§11 (الترقية الأكاديمية) ساقطتان.** وما عداهما — وفي مقدمته **ترقية الذاكرة §7.4**،
> وهي بنية نزاهة علمية لا ترقية أكاديمية — نافذ.
