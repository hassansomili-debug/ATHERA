...
نجاح الترحيل لا يعني أن RLS تعمل. هذا السكربت **يحاول** الممنوع ويفشل إن
نجح أيٌّ منه.

> ⚠️ **`scripts/verify_audit_chain.py` غير موجود في هذا المستودع.** كان
> مذكورًا هنا سطرًا ثانيًا، ومن اتّبع الدليل حرفيًّا لقي
> `No such file or directory` في منتصف إصدار. فأُزيل النداء وبقي الأثر:
> **النيّة قائمة ولم تُنفَّذ** — التحقّق من سلامة سلسلة تجزئة التدقيق في
> الإنتاج عملٌ مطلوب لم يُكتب بعد، ولا يُكتب بحذف سطرٍ من دليل.
> ومسارُ الإصدار المحكوم (`.github/workflows/production-release.yml`) لا
> ينادي أداةً غير موجودة، ويفحص وجودَ كلّ ما يناديه قبل أن يبدأ.

**وترتيبُ الإصدار لهذه الموجة وما بعدها في دليلٍ آخر:**
[`production-release.md`](production-release.md) — ترحيلٌ أوّلًا ثمّ نشر،
بحرّاسه ومنافذه وأسراره بأسمائها.
