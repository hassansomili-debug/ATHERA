 ...
 */
const GUARDED_PATHS = [
  // **`/ai` كانت غائبة عن هذه القائمة وهي أكثر ما يُفتح.** طلبه المسار د،
  // وهو في محلّه: الصفحة تقرأ وضع التشغيل وتُصيّر عليه، فهي بعينها الشكل
  // الذي يُنتج «جارٍ التحميل» لا ينتهي أو استثناءً في المتصفّح.
  "/ai",
  "/library",
  "/portfolio",
  "/references",
