...
const NAV_AR = {
  ...
  // **والاسمُ المعتمد «مركز الرسائل».** كان «الرسائل»، وقد تقاعد.
  // ومصفوفةُ التنقّل تدور على هذا الجدول كلِّه، فمفردةٌ بائتةٌ واحدة
  // تُسقط مسارات لا علاقةَ لها بالرسائل — وهو ما وقع.
  theses: "مركز الرسائل",
