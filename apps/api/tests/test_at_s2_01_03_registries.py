...
# و`scientific_writer` (S5E) انضمّ إليهما: كان يملك `memory.search_verified`
# ولم يستدعه مسارٌ واحد في التطبيق قط. وبحثٌ حرّ في الذاكرة أثناء صياغة قسم
# يعني سياقًا لا يعرفه أحد — يُخالف قاعدة «أقلّ سياق لازم»، ويُفلت من بصمة
# الإذن التي تُبنى من أدلة القسم بعينها. فسياقه يُجمَّع حتميًّا قبل النداء.
#
# بلا أدوات **قصدًا**: سياقها الوحيد ما يُمرَّر إليها، فلا ذاكرة تخلط بها
# ولا بحث تستورد منه ما ليس في المصدر.
TOOLLESS_BY_DESIGN = {"document_reader", "publication_planner", "scientific_writer"}
