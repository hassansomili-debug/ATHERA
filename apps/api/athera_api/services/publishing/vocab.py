...
# علاماتُ التحكّم الداخلية — **لا تظهر في نصّ مخطوطة أبدًا** (S5E §11).
#
# نضعها في الأدلة المُرسَلة إلى النموذج لنقول «هذه القيمة غير متاحة»، وهي
# لغةٌ بيننا وبينه لا نصٌّ يُنشر. وظهورها في مسودة يعني أنه نسخ تعليماتنا
# إلى الورقة.
#
# وموضعها هنا لا في حزمة الصياغة: **بوابة الجاهزية تحتاجها كذلك.** فحارسٌ
# عند التوليد وحده يترك نسخًا قديمة تحمل العلامة تمرّ إلى النشر — وقد وقع
# ذلك فعلًا: ثلاثة أقسام محفوظة في الإنتاج تحملها.
