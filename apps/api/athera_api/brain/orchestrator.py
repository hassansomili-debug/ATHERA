...
class Orchestrator:
    ...
    async def run_agent(
        ...
        *,
        ...
        # ── سياقٌ جُلب في هذا الطلب من خارج الأدوات ──
        #
        # **وبلا هذا يحجب الحاجزُ ما جلبناه بأنفسنا.** حاجز
        # `citations_must_be_grounded` يرفض كلّ DOI ليس في مجموعة الأدلة،
        # ومجموعتُها تُبنى من مخرَجات الأدوات وحدها. فطلبُ الباحث «ابحث لي
        # في الأدبيات» كان ينتهي بـ٤٢٢ صريحة: النموذج يذكر DOI أعطيناه
        # إيّاه قبل سطرين، فيُحجب مخرَجه كأنه اختلقه.
        #
        # ولا يُضعِف هذا الحاجز: ما يدخل هنا **جُلب من مزوّدٍ حقيقيّ في هذا
        # الطلب**، فهو غير المختلَق تعريفًا. وأنّه ليس دليلًا موثَّقًا يُقال
        # في حال الدليل التي تعود إلى الباحث، لا بحجب الجواب.
        ...
        # بالوسم نفسه، ويدخل مجموعة الأدلة التي يقيس عليها الحاجز.
